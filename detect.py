...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='weights/best4_12.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='D:/videos/4_12', help='file/dir/URL/glob, 0 for webcam')
    ...
    parser.add_argument('--project', default='D:/videos/4_12', help='save results to project/name')
